...
def main():
    ...
    try:
        with open("last.json", "r") as f:
            ...
            metashape_name = data.get("metashape_name", "")
            imgs_path_FLUO = data.get("imgs_path_FLUO", "")
            metashape_name_FLUO = data.get("metashape_name_FLUO", "")
            transf_FLUO_RGB = data.get("transf_FLUO_RGB", "")
            global_transf = data.get("global_transf", "")

    except FileNotFoundError:
        print("last.json not found. Using default empty paths.")
        main_path = ""
        imgs_path = ""
        masks_path = ""
        mesh_name = ""
    ...
    global_transf_var = tk.StringVar(value=global_transf)
    ...
    def set_global_transf():
        path = open_file_dialog()
        if path:
            global_transf_var.set(path)
    ...
    labels = [
        ...
        ("Global Transformation:", global_transf_var, set_global_transf)
    ]
    ...
    def on_ok():
        ...
        data = {
            ...
            "global_transf": global_transf_var.get()
        }
